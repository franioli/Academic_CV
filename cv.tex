...
% TOC entries are recorded (and PDF bookmarks created) but not printed here.
% (If you want a printed TOC later, re-enable \tableofcontents.)
...
\begin{paracol}{2}
    ...
    \begin{metasection}{Personal Details}
        ...
        \iconhref{Envelope}{12}{\small francescoioli@cnr.it}{mailto:francescoioli@cnr.it}{white}\\[4pt]
    ...
    \cvent{2020}{Internship}{Dept. of Civil and Environmental Engineering, Politecnico di Milano}{}{%   
        ...
        Obtained A1/A3 and A2 UAV licenses with permission for flying in critical standard scenarios.
    }
...
\cvbullet{
    \textbf{MSCA Postdoctoral Fellowships -- Seal of Excellence} [2024, 2025] \newline
    \textbf{Proposal Author} for the \textit{CryoLens} project proposal (Host institution: University of Twente, Supervisor: Prof. F. Nex; Secondment: Fondazione Montagna Sicura, Italy). \newline
    Awarded the MSCA Seal of Excellence in both calls with evaluation scores of 92.8\% (2024) and 95.4\% (2025). Although unfunded due to budgetary constraints,     the evaluation process confirms the proposal's scientific excellence and I gained experience with EU funding schema and in writing competitive grant application.
}\vspace{4pt}
...
\cvbullet{
    ...
    \textbf{Contributed to proposal writing}.\newline
...
\printbibliography[heading=none] \vspace{-4pt}
\textit{For a complete publication list, see \href{https://www.scopus.com/authid/detail.uri?authorId=57219022961}{Scopus profile: scopus.com/authid/detail.uri?authorId=57219022961}}
\normalsize%
...
\begin{itemize}[nosep]
    ...
    \item \textbf{COLMAP-SLAM Framework} (Core contributor): Visual odometry system for real-time photogrammetric positioning. \href{https://github.com/3DOM-FBK/COLMAP_SLAM}{[GitHub]} \href{https://doi.org/10.5194/isprs-archives-XLVIII-1-W1-2023-317-2023}{[Paper]}
\end{itemize}
...
\cventwide[noline]{2020 -- 2021}{Tutor for Alta Scuola Politecnica (ASP)}{Politecnico di Milano \& Politecnico di Torino}{}{%
    ASP is a joint degree program between Politecnico di Milano and Politecnico di Torino restricted to 150 talented students, selected among the applicants to MSc students in Engineering, Architecture and Design at the two universities based on their merits.
    Tutor for the ASP project \texttt{\textbf{Kuoleva J\"a\"atikk\"o}} focusing on designing and implementing from scratch a monitoring system using a time-lapse camera network using low-cost hardware with (Raspberry and Arudino) to track the volumetric decline of Belvedere Glacier~\href{https://www.asp-poli.it/kuoleva-j\%d3\%93\%d3\%93tikk\%d3\%a7/}{\texttt{(www.asp-poli.it/kuoleva-j\"a\"atikk\"o)}}.%
}

% ----- Teaching merits -----  
\cvsection{Teaching merits}

\cventwide{2020 -- 2024}{Teaching Assistant (TA)}{Politecnico di Milano}{Milan, Italy}{%
    Provided academic support and independent lecturing for the following BSc and MSc courses: \newline\newline
    \textbf{Photogrammetry and UAV Surveying (MSc)} | Fall 2024 (10 ECTS) \newline
    Professor: Mirko Reguzzoni \newline
    Role: 25 hours of independent lectures, material preparation, and student assessment ($\sim$50 students). \newline
    Activities: Lab and exercises on photogrammetric data acquisition, processing, and statistical evaluation. \newline
    Tools: Agisoft Metashape, Photomodeler, Matlab for data processing and visualization. \newline\newline
    \textbf{Statistics -- Trattamento delle Osservazioni (BSc)} | 2020 -- 2023 (8 ECTS) \newline
    Professor: Barbara Betti (2020-2021) -- Giovanna Venuti (2022-2023) \newline
    Role: 21--24 hours/year of frontal lectures and laboratory tutoring ($\sim$120--150 students). \newline
    Activities: Lectures on probability basics, laboratory on data cleaning, statistical inference, and least-squares model fitting. \newline
    Tools: Matlab for data exploration and statistical inference. \newline\newline
    \textbf{3D Modelling for Architecture (BSc/MSc)} | 2020 -- 2022 (4 ECTS) \newline
    Professor: Livio Pinto \newline
    Role: 10 hours of independent lectures and field survey coordination ($\sim$20 students). \newline
    Activities: Methodological and technological aspects of 3D surveying; practical building surveys with UAV and TLS; training on point cloud analysis, 3D representation, and professional terminology. \newline
    Tools: Agisoft Metashape, CloudCompare, TLS and UAV instrumentation. \newline\newline
    \textbf{GIS -- Sistemi Informativi Territoriali (BSc)} | 2020 -- 2021 (8 ECTS) \newline
    Professor: Federica Migliaccio \newline
    Role: 18 hours of laboratory sessions and course assignment reviews ($\sim$100 students). \newline
    Activities: Laboratory lessons using realistic case studies to teach core GIS software functionalities. \newline
    Tools: QGIS, ArcGIS.
}
...
\begin{itemize}[nosep]
    ...
    \item \textbf{2025:} Alpine Glaciological Meeting - Milano (Oral) \href{https://www.geo.uzh.ch/en/units/rse/news/alpine-glaciology-meeting-2024.html}{[Program]}.
...
\cventwide{2025--Present}{Scientific Volunteer}{Servizio Glaciologico Lombardo (SGL)}{Italy}{%
    Active member of the non-profit volunteer organization dedicated to the scientific research and monitoring of the Alpine glacial environment. Contribute to field data collection campaigns for glacier mass balance and retreat in response to climate change in Lombardy (Italy)
}

\cventwide{2025--present}{Volunteer (climate advocacy)}{Protect Our Winters (POW)}{}{%
    Contribute to initiatives that promote climate awareness and responsible engagement on climate impacts.
}

\cventwide[noline]{2024}{Open Data Day 2024}{Open Knowledge Foundation}{}{%
