...
\begin{paracol}{2}
    ...
    % ---- Profile -----
    I am a post-doctoral researcher at the \textbf{Research Institute for Geo-Hydrological Protection IRPI} at the Italian National Research Council (CNR).  
    I specialize in \textbf{photogrammetry and geoinformatics for environmental monitoring}.
    My research bridges the gap between traditional photogrammetry and modern computer vision, with a focus on leveraging deep learning for image matching and automated 3D reconstruction pipelines.

    I have experience with multi-scale 4D monitoring, ranging from \textbf{low-cost terrestrial sensors} for high-frequency glacier dynamics to \textbf{satellite multi-view stereo} for regional mass balance studies (developed at the University of Zurich).

    I have proven coding skills and experience with High-Performance Computing (HPC) for processing large-scale geospatial data. 
    As a supporter of open science, I actively develop open-source tools.
    I have field expertise as a topographer and I am a certified UAV pilot.
...
\begin{paracol}{2}
    ...
    \begin{metasection}{Tools}
            \textcolor{white}{
                \customicontext{assets/pytorch}{10}{PyTorch}{white} $\cdot$ \icontext{Eye}{10}{OpenCV}{white}\\[3pt]
                \customicontext{assets/docker}{10}{Docker}{white} $\cdot$ \icontext{Globe}{10}{Django}{white}\\[3pt]
                \icontext{Database}{10}{PostgreSQL $\cdot$ PostGIS}{white}\\[3pt]
                \icontext{Microchip}{10}{Raspberry Pi $\cdot$ Arduino}{white}\\[3pt]
                \icontext{Github}{10}{Git}{white} $\cdot$ \icontext{FileCode}{10}{LaTeX}{white}
            }
        \end{metasection}

    \begin{metasection}{Operating Systems}
        \icontext{Linux}{10}{Linux}{white} $\cdot$
    ...
    \cvent[noline]{2021 -- 2024}{PhD Environmental and Infrastructure Engineering}{Dept. of Civil and Environmental Engineering, Politecnico di Milano}{Milan, Italy}{%
        ...
        Thesis: \href{https://hdl.handle.net/10589/224092}{\textit{Multi-scale and Multi-temporal photogrammetry for Alpine Glacier Monitoring}}. Supervisor: prof. L. Pinto, co-supervisor: prof. F. Nex. \newline
    ...
    \cvent{04/2022 -- 07/2022}{Visiting PhD student}{University of Twente, ITC}{Enschede, Netherlands}{%
    ...
    \cvent{18 -- 24/\newline09/2022}{Summer School of Alpine Research}{University of Innsbruck}{Obergurgl, Austria}{%
    ...
    \cvent{09/2019 -- 02/2020}{Visiting student for MSc Thesis}{Dept. VAW, ETH Zürich}{Zürich, Switzerland}{%
    ...
    \cvent{2020}{Internship}{Dept. of Civil and Environmental Engineering, Politecnico di Milano}{Milano, Italy}{%   
    ...
    \cvent[noline]{2019}{Erasmus Exchange}{Aalto University}{Helsinki, Finland}{%
...
\cventwide[noline]{2019 -- 2024}{MSc Thesis Co-supervisor}{Politecnico di Milano}{Milan, Italy}{%
    ...
    \begin{itemize}[nosep]
        \item L. Cerina (2024): Analisi fotogrammetrica con immagini satellitari dell'evoluzione del Ghiacciaio del Belvedere (2009-2023) e impatto della colata detritica dell'agosto 2023. Supervisor: prof.\ L. Pinto. \href{https://www.politesi.polimi.it/handle/10589/234440}{[link]}
        \item S. Bonora (2024): Progettazione e implementazione di un database georeferenziato per il monitoraggio del Ghiacciaio del Belvedere. Supervisor: prof.\ F. Migliaccio. \href{https://www.politesi.polimi.it/handle/10589/222253}{[link]}
        \item I. Pincolini (2022): Digital image correlation for ice flow velocity estimation: a case study on the Belvedere glacier with UAV derived orthophotos. Supervisor: prof.\ L. Pinto. \href{https://www.politesi.polimi.it/handle/10589/204643}{[link]} 
        \item F. Barbieri (2021): Monitoraggio di aree alpine inaccessibili con fotogrammetria UAV low-cost. Supervisor: prof.\ L. Pinto. \href{https://www.politesi.polimi.it/handle/10589/177860}{[link]} 
        \item A. Pinto (2021): Tecniche fotogrammetriche da drone per la ricostruzione metrica di fessure su
              ponti in calcestruzzo. Supervisor: prof.\ L. Pinto. \href{https://www.politesi.polimi.it/handle/10589/188190}{[link]}
        \item F. Ferrario (2020): Triangolazione aerea assistita da DGPS in fotogrammetria da UAV:
              ...
              Pinto. \href{https://hdl.handle.net/10589/174486}{[link]}
    \end{itemize}
}
